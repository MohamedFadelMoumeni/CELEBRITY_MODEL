...
module.exports={
  ...
  "_spec": "clarifai",
  "_where": "C:\\Users\\thinkpad\\Desktop\\JS PROJECTS\\ai2",
  "author": {
    "name": "Clarifai Inc."
  },
  "bugs": {
...
const calculateFaceLocation = (data) => {
    ...
    const filterConcepts = concepts.sort((a, b) => b.value - a.value);
    const personConcepts = filterConcepts[0];
    conceptDiv.hidden = false;
    conceptName.textContent = `${personConcepts.name} - ${Math.floor(personConcepts.value * 100)}%`;
...
const sendData = () => {
    ...
    app.models.predict(Clarifai.CELEBRITY_MODEL, textElement.value)
